...
export const DATA_ID_PRIMARY =
  'text-xs text-brand font-medium font-mono truncate block';

/** Primary ID inline (e.g. inside flex); same as primary but no block */
export const DATA_ID_PRIMARY_INLINE =
  'text-xs text-brand font-medium font-mono truncate';
...
export const DATA_ID_PRIMARY_CLICKABLE =
  'text-xs text-brand font-medium font-mono hover:underline truncate block max-w-full';
...
export const DATA_AMOUNT = 'text-sm font-medium text-brand';
