...
export const TagInput: React.FC<TagInputProps> = ({
  ...
  return (
    <div className={cn('w-full', className)}>
      ...
      {/* Tags Container - matches vitals section input styling exactly */}
      <div
        className={cn(
          'w-full px-3 py-2 border rounded bg-white relative z-10',
          'transition-shadow',
          'focus-within:outline-none focus-within:ring-2 focus-within:ring-sky-500 focus-within:border-transparent',
          error ? 'border-red-500' : 'border-gray-300',
          'flex flex-wrap gap-2 items-center',
          // Ensure consistent height matching vitals section inputs
      ...
      >
        ...
        {/* Input Field - matches vitals section input styling exactly */}
        <input
          id={inputId}
          type="text"
          value={inputValue}
