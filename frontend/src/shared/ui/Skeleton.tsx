...
export const SkeletonTableRow: React.FC<{
  ...
  <div className={`flex items-center gap-4 py-4 px-6 border-b border-stroke ${className}`}>
...
export const SkeletonCard: React.FC<{
  ...
  <div className={`bg-panel rounded-md border border-stroke shadow-sm p-4 ${className}`}>
...
export const SkeletonPage: React.FC<{
  ...
  <div className={`p-6 space-y-6 ${className}`}>
    ...
    {/* Table */}
    <div className="bg-panel rounded-md border border-stroke shadow-sm">
      {/* Table header */}
      <div className="flex items-center gap-4 py-3 px-6 border border-stroke border-b bg-canvas">
