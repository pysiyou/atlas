        ...
        <div className="flex flex-col">
          ...
          {context && (
            <div className="flex flex-col gap-1.5 pt-3 border-t border-border">
              {(context.primary || context.secondary || context.tertiary) && (
                <div className="flex items-center gap-2 text-sm text-text-2 flex-wrap">
                  {context.primary}
              ...
              {metadata && <div className="text-xs text-text-3">{metadata}</div>}
            </div>
          )}
          ...
          {content && (
            <div className="pt-3 border-t border-border">
              <div className={`bg-canvas rounded-md p-3 border border-border-subtle ${contentClassName}`}>
                {contentTitle && (
                  <div className="text-xs font-medium text-text-3 uppercase tracking-wide mb-2">
                    {contentTitle}
                  </div>
                )}
                {content}
