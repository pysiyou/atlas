...
> = {
  ...
  'yellow-top': {
    label: 'Yellow Top',
    additive: 'ACD',
    commonUses: 'Blood bank, HLA typing',
  ...
  'orange-top': {
    label: 'Orange Top',
    additive: 'Thrombin',
    commonUses: 'STAT serum chemistry',
  ...
  'white-top': {
    ...
    commonUses: 'Molecular diagnostics',
    textClass: 'text-gray-400',
  },
  'tan-top': {
    label: 'Tan Top',
    additive: 'EDTA',
    commonUses: 'Lead testing',
    textClass: 'text-amber-600',
  },
  'urine-cup': { label: 'Urine Cup', commonUses: 'Urinalysis', textClass: 'text-yellow-500' },
  'stool-container': {
    label: 'Stool Container',
    commonUses: 'Stool analysis',
    textClass: 'text-amber-800',
  },
  'swab-tube': {
    label: 'Swab Tube',
    commonUses: 'Microbiology cultures',
  ...
  tube: {
    label: 'Tube',
    additive: 'Various',
    commonUses: 'General collection',
    textClass: 'text-gray-500',
  },
  other: {
    label: 'Other',
    additive: 'Various',
    commonUses: 'Miscellaneous',
    textClass: 'text-gray-500',
  },
};
