...
import type { LabBoardResponse } from '../api/labCommandCenter.service';
...
import type { LabAttentionQueueItem, LabCommandCenterSnapshot, LabPipelineStage } from './boardTypes';
