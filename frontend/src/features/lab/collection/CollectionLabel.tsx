      ...
      <body class="bg-surface m-0 p-0">
        <div class="label-wrapper">
          <div class="w-full max-w-[3.75in] flex flex-col items-center justify-center gap-1.5 p-2 border border-dashed border-border-strong print:border-none print:max-w-full print:p-0">
            <!-- Patient Name -->
            <div class="text-sm font-bold text-center text-text leading-snug w-full">
              ${patientName}
            </div>

            <!-- Patient ID and Sample Type -->
            <div class="text-xxs text-text-3 text-center leading-tight">
              ${patientIdDisplay} | ${sampleType.toUpperCase()}
            </div>

            <!-- Container Info -->
            <div class="w-full text-xxs font-bold text-center text-text bg-neutral-100 rounded px-2 py-1 print:py-0.5">
            ...
            <!-- Date and Time -->
            <div class="text-[9px] text-text-3 text-center leading-tight">
