...
import { buildCollectionDetailGridSections } from './SampleCollectionDetailGridSections';
import { SampleCollectionDetailContent } from './SampleCollectionDetailContent';
