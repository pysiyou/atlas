...
export const CollectionMobileCard: React.FC<CollectionMobileCardProps> = ({ display, onCollect }) => {
  ...
  const collectedVolume = (isCollected || isRejected) && 'collectedVolume' in sample 
    ? sample.collectedVolume 
    : undefined;
    ...
    >
      ...
      <div className="flex justify-between items-start mb-3 pb-3 border-b border-gray-100">
        ...
        {isPending ? (
          ...
          <Badge variant="success" size="xs">COLLECTED</Badge>
        ) : isRejected ? (
          <Badge variant="rejected" size="xs">REJECTED</Badge>
        ) : null}
      </div>
      ...
      <div className="flex justify-between items-center mt-auto pt-3">
        <div className="flex items-center gap-2">
          ...
          {isRecollection && (
            <Badge variant="warning" size="xs">RECOLLECTION</Badge>
          )}
        </div>
        {isPending ? (
