...
import { apiCategoryToTimelineLane, getLaneDisplay, type LabLaneDisplay } from '../constants/labConstants';
import type { TimelineEvent } from '../api/labCommandCenter';
import type { CommandCenterTimelineTone } from './labTimelineShared';
import {
  appendNote,
  formatTestCodes,
  metaString,
