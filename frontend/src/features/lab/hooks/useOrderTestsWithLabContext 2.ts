/**
 * useOrderTestsWithLabContext - Build TestWithContext[] from orders + testCatalog
...
import { getTestSampleType } from '@/features/catalog/testLookup';
import type { Order, OrderTest, TestStatus, TestWithContext } from '@/types';
import type { Test } from '@/types';
import { isCollectedSample } from '@/types';

export interface UseOrderTestsWithLabContextOptions {
...
export function useOrderTestsWithLabContext({
  orders,
  testCatalog,
  statusFilter,
...
}: UseOrderTestsWithLabContextOptions): TestWithContextResult[] {
