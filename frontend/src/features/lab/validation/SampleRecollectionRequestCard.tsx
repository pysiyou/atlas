/**
 * SampleRecollectionRequestCard — supervisor review for patient redraw approval.
...
import { compactAuditLines } from '../components/labWorkflowAuditLines';
...
export const SampleRecollectionRequestCard: React.FC<RecollectionRequestCardProps> = ({
  request,
  onApprove,
  onDeny,
  isApproving = false,
