    ...
    <Alert variant="warning" className={isCompact ? 'py-space-1-5' : 'py-space-2'}>
      <div className="space-y-space-1">
        <div>
          ...
          <p
            className={`text-text-secondary leading-tight mt-space-0-5 ${isCompact ? 'text-xxs' : 'text-xs'}`}
          >
        ...
        <div
          className={`space-y-space-0-5 ${isCompact ? 'text-xxs' : 'text-xs'} text-text-tertiary leading-tight`}
        >
