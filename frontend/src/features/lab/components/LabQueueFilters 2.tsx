/**
 * LabQueueFilters - Shared filter row for lab workflow tabs
...
export interface LabQueueFiltersProps<S = string[]> {
  config: FilterConfig;
  searchQuery: string;
...
export function LabQueueFilters<S = string[]>({
  config,
  searchQuery,
  onSearchChange,
  dateRange,
...
}: LabQueueFiltersProps<S>): React.ReactElement {
