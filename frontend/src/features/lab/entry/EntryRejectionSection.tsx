  ...
  return (
    <div className="space-y-1.5 text-xs">
      ...
      <div className="flex items-center">
        <span className="text-text-3 w-16 shrink-0">Type</span>
      ...
      {record.rejectionReason && (
        <div className="flex">
          <span className="text-text-3 w-16 shrink-0">Reason</span>
          <span className="text-text">{record.rejectionReason}</span>
        </div>
      )}
      ...
      {record.rejectedBy && (
        <div className="flex">
          ...
          <span className="text-text">{getUserName(record.rejectedBy)}</span>
        </div>
      )}
      ...
      {record.rejectedAt && (
        <div className="flex">
          ...
          <span className="text-text">{formatDate(record.rejectedAt)}</span>
        </div>
      )}
    </div>
  );
  ...
  return (
    <div className="text-xs text-text-3">
      ...
      {rejection.rejectionReason && (
        <span className="text-text-3"> · {rejection.rejectionReason}</span>
      )}
    </div>
  );
};
