  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start mb-3 pb-3 border-b border-border">
        ...
        <div className="font-medium text-text text-lg">{formatCurrency(order.totalPrice)}</div>
      </div>
          ...
          <div className="space-y-1">
            ...
            {activeTests.slice(0, 2).map((test, index) => (
              <div
                ...
                className="flex items-center justify-between text-xs text-text-2"
              >
                <div className="flex items-center flex-1 min-w-0">
                  ...
                  <span className="font-mono text-primary truncate">{test.testCode}</span>
                </div>
                <span className="font-medium text-text ml-2 shrink-0">
      ...
      <div className="flex justify-between items-center mt-auto pt-3">
        ...
        <div className="text-xs text-text-3">{formatDate(order.orderDate)}</div>
