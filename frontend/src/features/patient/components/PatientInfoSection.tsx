    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex items-start gap-3">
          <Icon name={ICONS.dataFields.user} className="w-5 h-5 text-text-disabled mt-1" />
          <div className="flex-1">
            <div className="text-xs text-text-tertiary mb-1">Full Name</div>
            <div className="font-normal text-text-primary">{patient.fullName}</div>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <div className="text-xs text-text-tertiary mb-1">Age & Gender</div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <div className="text-xs text-text-tertiary mb-1">Phone</div>
            <div className="font-normal text-text-primary">{formatPhoneNumber(patient.phone)}</div>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="font-normal text-text-primary">{patient.email || 'Not provided'}</div>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3 md:col-span-2">
          ...
          <div className="flex-1">
            ...
            <div className="font-normal text-text-primary">{patient.address.street}</div>
      ...
      <div className="mt-4 pt-4 border-t border-border-default">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="font-normal text-text-primary">{patient.emergencyContact.fullName}</div>
            <div className="text-xs text-text-tertiary mt-1">
      ...
      <div className="mt-4 pt-4 border-t border-border-default">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <div className="text-xs text-text-tertiary mb-2">Lab Affiliation</div>
            {!patient.affiliation ? (
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="text-xs text-text-tertiary">
                  Assurance #:{' '}
                  <span className="font-mono font-normal text-text-primary">
                ...
                <div className="text-xs text-text-tertiary">
                  Expires:{' '}
                  <span
                    className={`font-normal ${isAffiliationActive(patient.affiliation) ? 'text-text-primary' : 'text-danger-fg'}`}
                  >
      ...
      <div className="mt-4 pt-4 border-t border-border-default">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <div className="text-xs text-text-tertiary mb-1">Registration Date</div>
              <div className="font-normal text-text-primary">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="font-normal text-text-primary">{formatDate(patient.updatedAt)}</div>
