...
export const OrderHistoryCard: React.FC<OrderHistoryCardProps> = ({
  ...
  return (
    ...
    >
      {/* Order count */}
      <div className="text-xs text-text-tertiary -mt-2 mb-2">{orders.length} order(s) found</div>
      ...
      <div className="flex-1 overflow-y-auto min-h-0">
        {orders.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-text-tertiary font-normal mb-2">No orders found</p>
            <p className="text-sm text-text-tertiary mb-4">Create a new order for this patient</p>
          ...
          <div className="space-y-3">
            {orders.slice(0, 10).map(order => (
              <div
                ...
                className="border border-border-default rounded-lg p-4 hover:border-brand hover:bg-brand-muted transition-colors cursor-pointer"
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="font-normal text-text-primary text-sm font-mono">
