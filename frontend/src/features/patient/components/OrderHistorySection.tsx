...
export const OrderHistoryCard: React.FC<OrderHistoryCardProps> = ({
  ...
  return (
    ...
    >
      {/* Order count */}
      <div className="text-xs text-fg-subtle -mt-2 mb-2">{orders.length} order(s) found</div>
          ...
          <div className="space-y-3">
            {orders.slice(0, 10).map(order => (
              <div
                ...
                className="border border-stroke rounded-lg p-4 hover:border-brand hover:bg-brand-muted transition-colors cursor-pointer"
              >
