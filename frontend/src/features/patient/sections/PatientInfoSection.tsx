    ...
    >
      ...
      <div className="flex items-start gap-3 pb-3 border-b border-border-strong">
        ...
        <div className="flex-1">
          ...
          <div className="font-mono font-medium text-text-primary">{displayId.patient(patient.id)}</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="font-medium text-text-primary">{patient.fullName}</div>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="font-medium text-text-primary">{formatPhoneNumber(patient.phone)}</div>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="font-medium text-text-primary">{patient.email || 'Not provided'}</div>
          </div>
        </div>
