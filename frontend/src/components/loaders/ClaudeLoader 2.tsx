// src/components/loaders/ClaudeLoader.tsx
/**
 * ClaudeLoader — radial “starburst” loader (animated spokes).
 * Restored from pre–DNA-helix LoadingSpinner.tsx (feat: Claude loading UX).
 */
...
export const ClaudeLoader: React.FC<ClaudeLoaderProps> = ({
  ...
  return (
    <svg
      ...
      className="claude-loader motion-reduce:opacity-80"
      aria-hidden="true"
    >
