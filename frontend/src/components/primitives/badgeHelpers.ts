/**
 * Badge Color System
 * Domain color maps inlined from removed ui/orders.ts, ui/samples.ts, ui/payments.ts, ui/catalog.ts
 */

import { MISC_COLOR_MAP } from '@/components/display/displayUtils';
