...
class AuditService(AuditLogMixin):
    ...
    def get_entity_history(self, entity_type: str, entity_id: int) -> list[LabOperationLog]:
        """
        ...
        return (
            ...
            .filter(
                LabOperationLog.entityType == entity_type, LabOperationLog.entityId == entity_id
            )
    ...
    def get_user_operations(
        self,
        user_id: int,
        operation_types: list[LabOperationType] | None = None,
        limit: int = 10000,
        ...
        """
        query = self.db.query(LabOperationLog).filter(LabOperationLog.performedBy == user_id)
